                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <?php else : ?>
                                ...
                                <a href="/signin"
                                   class="<?= urlIs('/signin') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Sign In</a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="ml-3">
                        <form method="post" action="/session">
                            ...
                            <button class="text-white text-sm">Sign Out</button>
                        </form>
                    </div>
                    <?php endif; ?>
                </div>
